...
const About = () => {
  return (
    <div>
        <section className='p-8 min-h-screen w-full text-black grid grid-cols-1 justify-center gap-4 bg-[url(/backgroundimg.avif)] object-fill'>
            <div className=' md:max-w-[50vw] mx-auto'>
                <p  className='text-3xl font-semibold'>
                    <h2 className='text-7xl font-extrabold align-bottom md:pt-[150px] flex justify-center'>About Us.</h2><br></br>
        ...
        <div className='bg-gray-300 min-h-[50vh] text-black pb-10 md:pb-28 px-8 md:px-16 grid md:grid-cols-2 gap-10 text-2xl font-medium'>
        ...
        <div className='h-full grid md:grid-cols-2 gap-6 md:gap-10 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            ...
            <div className='text-2xl font-normal flex flex-col gap-5'>
        ...
        <div className='h-full grid md:grid-cols-2 gap-6 md:gap-10 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            <div className='text-2xl font-normal flex flex-col gap-5'>
                <h1 className='text-4xl font-bold'>GREAT TEAM WORK</h1>
        ...
        <div className='h-full grid md:grid-cols-2 gap-6 md:gap-10 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            ...
            <div className='text-2xl font-normal flex flex-col gap-5'>
                <h1 className='text-6xl font-bold flex justify-center'> Bussiness 2022 </h1>
                <div className='grid gap-4'>
                    <div  className='text-2xl font-normal flex flex-col gap-3'>
                    ...
                    <div  className='text-2xl font-normal flex flex-col gap-3'>
                        <h1 className='text-4xl font-bold'>Covid-19 and Measures</h1>
                    ...
                    <div  className='text-2xl font-normal flex flex-col gap-3'>
                        <h1 className='text-4xl font-bold'>100% Chemical Solution</h1>
