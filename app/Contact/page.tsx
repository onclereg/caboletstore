...
const Contact = () => {
  return (
    <div>
        <section className='p-8 min-h-screen w-full text-black grid justify-center align-baseline gap-4 bg-[url(/chem5.jpg)] bg-cover'>
            <div className=' md:max-w-[60vw] mx-auto '>
                <p  className='text-3xl font-semibold'>
                 <span className='text-7xl font-extrabold align-bottom md:pt-[250px]  flex justify-center'>CONTACT US</span><br></br>
        ...
        <div className='grid md:grid-cols-2 gap-20 text-xl font-medium text-black bg-white px-6 md:px-12 py-10 md:py-[100px]'>
            <div className='grid gap-5'>
                <h1 className='text-3xl font-semibold'>Would you like to get in touch privately?</h1>
