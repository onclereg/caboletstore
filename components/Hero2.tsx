...
const Hero2 = () => {
  return (
    <div>
        <div className='h-full grid md:grid-cols-2 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            <div className='grid gap-6'>
                <h1 className='text-7xl font-bold'>Process & Capabilities</h1>
        ...
        <section className='w-full h-full text-black grid lg:grid-cols-3 bg-linear-to-r from-white to-indigo-300 px-6 py-[150px] text-2xl'>
            <div  className='grid gap-5'>
                ...
                <div className=''>
                    <h1 className='text-6xl font-bold'>Sustainable Solution Empowerment</h1>
            ...
            <div className='grid gap-5'>               
                <div className=''>
                    <h1 className='text-6xl font-bold'>Management, Goals and Dialog</h1>
            ...
            <div  className='grid gap-5'>
                ...
                <div className=''>
                    <h1 className='text-6xl font-bold'>We create Chemistry for a Sustainable Future</h1>
        ...
        <div className='h-full grid md:grid-cols-2 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            <div className='grid gap-2'>
                <h1 className='text-[100px] font-bold'>Our Circular Economy Involvement</h1>
        ...
        <div className='h-full grid md:grid-cols-2 gap-6 md:gap-10 bg-white text-black text-3xl font-semibold px-14 py-[150px]'>
            ...
            <div className='grid gap-2'>
                <h1 className='text-7xl font-normal'>Trusted Chemicals</h1>
                <p>We are your No.1 Stop for Chemicals.
                CCC’s Chemical Services is a leading UK chemical manufacturing and selling company with over 15 years’ experience.</p>
                <div>
                    <button className='bg-red-500 p-3 my-3 rounded-2xl text-2xl'>GET IN TOUCH</button>
                </div>
            </div>
