...
const Footer = () => {
  return (
    <div className=' text-white bg-red-900 w-full min-h-[20%] '>
        <div className='px-6 py-8 md:py-[100px] grid md:grid-cols-2 font-medium '>
            <div className='text-2xl grid gap-5'>
                <Logo/>
            ...
            <div className='grid gap-4 md:grid-cols-3 justify-evenly'>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-black dark:text-white text-xl">
                        <li><a href="#" className=" hover:text-primary">Send Us An Email</a></li>
                        <li><a href="#" className=" hover:text-primary">Call Us Today</a></li>
                    </ul>
                </div>
                <div>
        ...
        <div className='px-6 py-4 md:py-7 border-t border-grey flex justify-center'>
            <p className='font-medium text-xl'>
                Copyright © 2023 Cabolet Coat Chemicals | Powered by Zeppas Coat Chemicals
            </p>
        </div>
    </div>
  )
